          ...
          <div className={styles["form-container"]}>
            <form onSubmit={submitHandler}>
              ...
              <div className={styles["column-container"]}>
                ...
                <div className={styles.heading}>
                  <label className={styles["heading-input"]}>
                    How many caravans would you like to welcome?
                  </label>
                ...
                <label className={styles.container}>
                  ...
                  <input
                    ...
                    onChange={SearchContext.collectLocationData}
                    checked={
                      SearchContext.locationData.essentialAmenities.toilet
                    }
                  />
                  <span className={styles.checkmark}></span>
                </label>
              ...
              <div className={styles.heading}>
                ...
                <label className={styles["property-details"]}>
                  Give guests a sense of what it's like to stay at your
                  property, including why the'll love staying there.
                </label>
                <textarea
                  type="text"
                  // resize="none"
              ...
              <div className={styles.heading}>
                ...
                <label className={styles["property-details"]}>
                  Provide a general description of what the property and rooms
                  are like so guestts know what to expect.
                </label>
                ...
                />
                <label className={styles["property-details"]}>
                  Let guests know how they can get around the neighbourhood.
                </label>
                <textarea
                  type="text"
                  // resize="none"
                ...
                <label className={styles["property-details"]}>
                  Tell guests if you'll be available to offer help throughout
                  thei stay and how you'll keep in touch with them.
                </label>
                <textarea
                  type="text"
                  // resize="none"
                ...
                <label className={styles["property-details"]}>
                  Include any special info you want potential guests to know
                  before booking that isn't covered in other settings.
                </label>
                <textarea
                  type="text"
                  // resize="none"
              ...
              <div className={styles.heading}>
                ...
                <label className={styles["property-details"]}>
                  Share some highlights about the neighbourhood.
                </label>
